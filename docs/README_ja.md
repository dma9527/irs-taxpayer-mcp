...
**明示的にモデル化されたTY2024からTY2026のシナリオ向けに、44の税額見積もり・計画ツールを提供するMCPサーバーです。**
...
>
> **対応範囲**：本プロジェクトは決定論的な税額見積もり・計画エンジンです。申告書の作成、署名、送信は行いません。州税の参照データは50州とDCを対象としますが、数値見積もりは明示的にモデル化された経路のみをサポートします。
...
| 税務計画   | 7   | ローカル構造化プラン、年末最適化、年度比較、自営業税、住宅ローン、教育、MFJ vs MFS |
...
| ガイド     | 4   | ヘルスチェック、税務ルール検索、フォームガイド、フィードバックリンク         |

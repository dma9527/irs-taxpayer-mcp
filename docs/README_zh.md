...
**面向美国个人纳税人的 MCP 税务估算与规划服务器，包含 44 个工具，支持明确建模的 TY2024 至 TY2026 场景。**
...
>
> **支持边界**：本项目是确定性的税务估算与规划引擎，不会生成、签署或提交 tax return。州税参考数据覆盖 50 州和 DC，但数值估算仅支持明确建模的路径，其他路径会返回错误。
...
| 税务规划   | 7      | 本地结构化方案、年末优化、跨年对比、自雇税、房贷、教育、MFJ vs MFS |

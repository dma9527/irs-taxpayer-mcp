...
export const TAX_CREDITS: CreditRule[] = [
  // === FAMILY ===
  {
    ...
    maxAmount: "TY2024: $2,000 per qualifying child. TY2025: $2,200 per child (OBBB). Up to $1,700 refundable (Additional CTC)",
  ...
  },
  {
    ...
    maxAmount: "TY2024: $16,810 per child. TY2025: $17,280 per child (partially refundable up to $5,000 per OBBB)",
    eligibility: "Qualified adoption expenses for eligible child",
    phaseout: "TY2024: begins at $252,150 MAGI, fully phased out at $292,150. TY2025: adjusted for inflation",
    form: "Form 8839",
  },
  ...
  // === INCOME-BASED ===
  {
    ...
    maxAmount: "TY2024: $632 (0 children) / $3,995 (1) / $6,604 (2) / $7,430 (3+). TY2025: $649 / $4,111 / $6,796 / $7,645",
    eligibility: "Must have earned income, meet AGI limits, SSN, US citizen/resident, not MFS, investment income < $11,600 (TY2024) / $11,950 (TY2025)",

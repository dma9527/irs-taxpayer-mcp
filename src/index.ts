...
registerComprehensiveTools(server);    // 9 tools: report, 1099, calendar, paycheck, scenario, audit, docs, capgains, retirement
...
async function startStdio(): Promise<void> {
  ...
  console.error("IRS Taxpayer MCP server running on stdio — 37 tools loaded");
}

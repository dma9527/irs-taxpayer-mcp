  ...
  server.tool(
    ...
    wrapToolHandler(async (params) => {
      ...
      const federalResult = calculateTax({
        ...
        aotcStudentQualifiedExpenses: params.aotcStudentQualifiedExpenses,
        aotcRefundableAllowed: params.aotcRefundableAllowed,
        lifetimeLearningQualifiedExpenses:
          params.lifetimeLearningQualifiedExpenses,
      ...
      const lines = [
        ...
        federalResult.nonrefundableAmericanOpportunityCreditApplied > 0 ? `| American Opportunity Credit (nonrefundable) | -$${fmt(federalResult.nonrefundableAmericanOpportunityCreditApplied)} |` : "",
        federalResult.lifetimeLearningCreditApplied > 0 ? `| Lifetime Learning Credit | -$${fmt(federalResult.lifetimeLearningCreditApplied)} |` : "",
        ...
        federalResult.refundableAmericanOpportunityCredit > 0 ? `| American Opportunity Credit (refundable) | -$${fmt(federalResult.refundableAmericanOpportunityCredit)} |` : "",

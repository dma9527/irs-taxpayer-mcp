...
export const ERRORS = {
  unsupportedYear: (year: number) => toolError({
    ...
    suggestion: "Use taxYear 2024, 2025, or 2026. Data is sourced from IRS Rev. Proc. 2023-34 (TY2024), Rev. Proc. 2024-40 + OBBB Act (TY2025), and Rev. Proc. 2025-32 (TY2026).",
  }),
